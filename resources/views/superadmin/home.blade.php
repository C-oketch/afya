...
<div class="wrapper wrapper-content animated fadeInRight">
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="ibox">
                            <div class="ibox-content ">
                                <h5 class="m-b-md"> Pharmacy <i class="fa fa-hospital-o" style="font-size:20px;color:green"></i> </h5>
                                <h2 class="text-navy">
                    ...
                    <div class="col-lg-3">
                        <div class="ibox">
                            <div class="ibox-content">
                                <h5 class="m-b-md">Doctors <i class="fa fa-user-md" style="font-size:20px;color:green"></i></h5>
                                <h2 class="text-navy">
                                    <i class="fa fa-play fa-rotate-270"></i> Up
                                </h2>
                    ...
                    <div class="col-lg-3">
                        <div class="ibox">
                            <div class="ibox-content">
                                <h5 class="m-b-md">Manufacturers <i class="fa fa-building-o" style="font-size:20px;color:red"></i></h5>
                     ...
                     <div class="col-lg-3">
                        <div class="ibox">
                            <div class="ibox-content">
                                <h5 class="m-b-md">Patients <i class="fa fa-users" style="font-size:20px;color:red"></i></h5>
                                <h2 class="text-danger">
                                    <i class="fa fa-play fa-rotate-90"></i> Down
                                </h2>
                                <small>Server down since 4:32 pm.</small>
