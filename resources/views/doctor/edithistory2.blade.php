...
<div class="row wrapper white-bg page-heading">
              ...
              <div class="col-lg-4">
                  <div class="title-action">
                      ...
                      <a href="{{url('doctor.medica_report2',$user->appid)}}"  class="btn btn-primary"><i class="fa fa-angle-double-left"></i> BACK </a>
  ...
  <div class="row"  id="div_print">
      ...
      <div class="ibox float-e-margins">
        <div class="col-lg-12">
          ...
          <form class="form-horizontal" role="form" method="POST" action="/mrPatients2" >
...
<li class="list-group-item fist-item">
  {{$impress->notes}}        <a href="{{route('imp2_delete', ['impid'=>$impress->id, 'appid'=>$user->appid])}}" class="marg">Remove</a>
...
<li class="list-group-item fist-item">
  {{$cmeds->drugs}}  <a href="{{route('cm2_delete', ['cmid'=>$cmeds->id, 'appid'=>$user->appid])}}" class="marg">Remove</a>
</li>
@endforeach
</ul>
...
<li class="list-group-item fist-item">
{{$tst1->disease_id}}  <a href="{{route('diag2_delete', ['diagid'=>$tst1->id, 'appid'=>$user->appid])}}" class="marg">Remove</a>
