...
?>
<?php
$frepo = DB::table('xray_findings')
->leftJoin('radiology_test_result', 'xray_findings.id', '=', 'radiology_test_result.findings_id')
->where([['xray_findings.xray_id', '=',$tsts1->xrayid],['radiology_test_result.radiology_td_id', '=',$tsts1->rtdid]])
->select('radiology_test_result.results','xray_findings.findings','radiology_test_result.created_at')
->first();
	?>
	<p>
