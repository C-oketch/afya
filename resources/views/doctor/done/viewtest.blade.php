...
<div class="row wrapper border-bottom white-bg page-heading">
	...
	<div class="col-lg-4">
		<div class="title-action">
			...
			<a href="{{route('tstdetails',$tsts1->ptid)}}"  class="btn btn-primary"><i class="fa fa-angle-double-left"></i> Back </a>
			<button name="b_print" class="btn btn-primary ipt" type="button" onClick="printdiv('div_print');"><i class="fa fa-print"></i> Print Invoice </button>
		</div>
	</div>
</div>
