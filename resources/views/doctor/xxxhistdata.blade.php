...
<div class="row wrapper border-bottom white-bg page-heading">
              ...
              <div class="col-lg-2">
                <br><br><br>
                <a href="{{ url('doctor.show',$patient->id) }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back </a>
...
{!! Form::open(array('url' => 'doctor.doc_store','method'=>'POST','class'=>'form-horizontal')) !!}
...
<select multiple="multiple" id="chronic" name="chronic[]" class="form-control chronic" style="width:100%" ></select>
                            ...
                            <div class="step-content">
                              <div class="col-lg-4 b-r">
                                ...
                                <div>
                                  <input type="text" name="drug_id" class="form-control daily">
                                </div>
                                </div>
                                <div class="form-group col-md-11">
                                 <label class="control-label" for="name">Dosage</label>
                                 <input type="text" name="dosage" class="form-control daily">
                                </div>
                                <div class="form-group col-md-11" id="data_1">
                                 <label class="control-label" for="name">Medication Date</label>
                                 <div class="input-group date">
                                     <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                     <input type="text" class="form-control" name="med_date" value="{{$today = date('Y-m-d')}}">
                                 </div>
                                </div>
...
<div class="col-sm-6">
  ...
  <div class="form-group col-sm-6">
  <label class="control-label" for="name">Abnormality</label>
  <input type="text" name="abnm4" class="form-control daily"  placeholder="Apetite">
  </div>
  <div class="form-group col-sm-6">
  <label class="control-label" for="name">Abnormality Status</label>
  <input type="text" name="abnm44" class="form-control daily"  placeholder="200/01/12">
  </div>
