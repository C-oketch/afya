...
<div class="ibox-content">
    <div class="row">
      <div class="col-md-10">
        <div class="">
            <a href="{{url('test-all',$app_id)}}" class="btn btn-primary pull-right">VIEW ADDED TEST</a>
        <h4>ALL TESTS</h4>
        </div>
        <div class="col-md-10">
...
<span class="btn btn-info btn-block m-t">
  <i class="fa fa-arrow-down"></i> Radiology Test
</span>
...
<div class="ibox float-e-margins">
  <span class="btn btn-info btn-block m-t">
    <i class="fa fa-arrow-down"></i>Procedures</span>
<div class="ibox-content">
  @if($procedurec)
  <div class="form-group">
  ...
  <select class="form-control m-b select2_demo_1"  name="pcardiac[]" multiple>
   ...
   <select class="form-control m-b select2_demo_1"  name="pneurology[]" multiple>
     ...
     ->Join('appointments', 'patient_procedure_details.appointment_id', '=', 'appointments.id')
     ->select('patient_procedure_details.id','appointments.id as appp')
     ->Where([['patient_procedure_details.procedure_id',$procn->id],
             ['appointments.afya_user_id',$afyauserId],
             ['patient_procedure_details.done',0],
             ['patient_procedure_details.deleted',0],
           ])
    ...
    @endif
    <div class=" col-md-4">
      <button class="btn btn-primary btn-block m-t" id="myBtn" type="submit"><strong>Submit</strong></button>
<br>
     </div>
</div>
</div>
