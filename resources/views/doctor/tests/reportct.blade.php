...
?>
      ...
      $tst21 = DB::table('radiology_test_result')->select('results')->where('radiology_td_id', '=',$tsts1->id)->first();
       ...
       <div class="wrapper wrapper-content animated fadeInRight">
              ...
              {{ Form::open(array('route' => array('doc.ctResult'),'method'=>'POST')) }}
                  <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                 ...
                                 <div class="col-sm-6"><h4></h4>
                                    {!! Form::open(array('url' => 'doc.ctupload','files'=>true)) !!}
                              <input type="hidden" name="_token" value="{{ csrf_token() }}">
       ...
       <td><a class="btn btn-danger"  href="{{route('remove.ctupload',$image->id)}}"> Remove </a></td>
       </tr>
       @endforeach
       </tbody>
       </table>
