...
{!! Form::open(array('url' => 'mriTest','method'=>'POST')) !!}
...
<textarea rows="4" name="clinical" id="docnote" cols="50" class="form-control"></textarea>
</div>
...
<div class="modal-body">
  {!! Form::open(array('url' => 'mriTestremove','method'=>'POST')) !!}
