        ...
        <div class="ibox-content">
          <div class="row">
            <div class="col-sm-6 b-r"><h3 class="m-t-none m-b"></h3>
              {{ Form::open(array('route' => array('doc.mriResult'),'method'=>'POST')) }}
              ...
              <div class="col-md-12">
                <button class=" mtop btn btn-sm btn-primary  m-t-n-xs" type="submit"><strong>              @if($tst21) Update  @else   Submit      @endif
</strong></button>
              </div>
            ...
            <div class="col-sm-6"><h4></h4>
              {!! Form::open(array('url' => 'doc.mriupload','files'=>true)) !!}
              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                  ...
                  <table class="table table-striped">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a class="btn btn-danger"  href="{{route('remove.mriupload',$image->id)}}"> Remove </a></td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
