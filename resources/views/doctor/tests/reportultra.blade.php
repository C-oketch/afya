...
?>
      ...
      <?php
      $tst21 = DB::table('radiology_test_result')->select('results')->where('radiology_td_id', '=',$tsts1->id)->first();
       ?>
                 ...
                 <div class="col-lg-12">
                     <div class="ibox float-e-margins">
                         ...
                         <div class="ibox-content">
                            ...
                            {{ Form::open(array('route' => array('doc.ultraResult'),'method'=>'POST')) }}
                  <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                         ...
                                         @if($tsts1->technique)
                                             ...
                                             <div class="form-group">
                                               ...
                                               <textarea rows="6" name="note" cols="50">@if($tst21){{$tst21->results}} @endif</textarea>
                                             </div>
                                 ...
                                 <div class="col-sm-6"><h4></h4>
                                    {!! Form::open(array('url' => 'doc.ultraupload','files'=>true)) !!}
                              <input type="hidden" name="_token" value="{{ csrf_token() }}">
       ...
       <td><a class="btn btn-danger"  href="{{route('remove.ultraupload',$image->id)}}"> Remove </a></td>
       </tr>
       @endforeach
       </tbody>
       </table>
