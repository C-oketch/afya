...
@if($datadetails)
<td>
  <button class="delete-modal btn btn-danger" data-rtd="{{$datadetails->id}}" data-appid="{{$app_id}}"
      data-name="{{$ctt->name}}"  data-cat_id="{{$ctt->test_cat_id}}">
...
<div class="modal-body">
  {!! Form::open(array('url' => 'otherTest','method'=>'POST')) !!}
...
<div class="modal-body">
  {!! Form::open(array('url' => 'Otherremove','method'=>'POST')) !!}
