...
<li class="active"><a href="{{ route('doctor.abnorhistdata',$app_id) }}">Functions</a></li>
...
<h3>Functions</h3>
{!! Form::open(array('url' => 'doctor.abnormal','method'=>'POST' ,'id'=>'add_proc')) !!}
...
<tr id="row1">
<td><input type="text" name="members[0][name]" placeholder="Function Name" class="form-control"></td>
<td><input type="text" name="members[0][notes]" placeholder="Description" class="form-control"></td>
...
$rowno=$rowno+1;
$("#procedure_table tr:last").after("<tr id='row"+$rowno+"'><td><input type='text' name='members["+$rowno+"][name]' class='form-control' placeholder='Function Name'></td><td><input type='text' name='members["+$rowno+"][notes]' placeholder='Description' class='form-control'></td><td><input type='hidden' name='members["+$rowno+"][afya_user_id]' value='{{$patient->id}}'><input type='button' class='btn btn-danger' value='DELETE' onclick=delete_row('row"+$rowno+"')></td></tr>");
}
