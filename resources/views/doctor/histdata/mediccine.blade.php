    ...
    <div class="tabs-container">
      ...
      <div class="tabs-left">
        <ul class="nav nav-tabs">
          ...
          <li class="active"><a href="{{ route('doctor.medhistdata',$app_id) }}">Medications</a></li>
        ...
        <div class="tab-content ">
          <div id="tab-6" class="tab-pane active">
            <div class="panel-body">
              ...
              {!! Form::open(array('url' => 'doctor.drug','method'=>'POST' ,'id'=>'add_proc')) !!}
              ...
              <div class="table-responsive">
                <table class="table borderless" id="procedure_table" align=center>
                  <tr id="row1">
                    <td><input type="text" name="members[0][drug_id]" placeholder="Drug Details" class="form-control"></td>
...
function add_row_proc()
{
  ...
  $rowno=$rowno+1;
  $("#procedure_table tr:last").after("<tr id='row"+$rowno+"'><td><input type='text' name='members["+$rowno+"][drug_id]' class='form-control' placeholder='Drug Details'></td><td><input type='hidden' name='members["+$rowno+"][afya_user_id]' value='{{$patient->id}}'><input type='button' class='btn btn-danger' value='DELETE' onclick=delete_row('row"+$rowno+"')></td></tr>");
}
