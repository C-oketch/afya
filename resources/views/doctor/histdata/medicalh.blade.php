    ...
    <div class="tabs-container">
      ...
      <div class="tabs-left">
        <ul class="nav nav-tabs">
          ...
          <li class="active"><a href="{{ url('doctor.medicalhistdata',$app_id) }}" >Medical History</a></li>
        ...
        <div class="tab-content ">
          <div id="tab-6" class="tab-pane active">
            <div class="panel-body">
              ...
              <div id="form_div">
                {!! Form::open(array('url' => 'doctor.medical','method'=>'POST','id'=>'add_name')) !!}
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <input type="hidden" name="appId"  value="{{$patient->appid}}" >
                <div class="table-responsive">
                  <table class="table borderless" id="employee_table" align=center>
                    <tr id="row1">
                      ...
                      <td><input type="hidden" name="members[0][appointment_id]"  value="{{$patient->appid}}" class="form-control"></td>
                    </tr>
                  </table>
