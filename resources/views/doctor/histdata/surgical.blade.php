    ...
    <div class="tabs-container">
      ...
      <div class="tabs-left">
        <ul class="nav nav-tabs">
          ...
          <li  class="active"><a href="{{ route('doctor.surghistdata',$app_id) }}" >Surgical Procedures</a></li>
          ...
          <li class=""><a href="{{ route('doctor.chronichistdata',$app_id) }}" >Chronic Disease</a></li>
        ...
        <div class="tab-content ">
          <div id="tab-6" class="tab-pane active">
            <div class="panel-body">
              ...
              {!! Form::open(array('url' => 'doctor.surgical','method'=>'POST' ,'id'=>'add_proc')) !!}
              ...
              <div class="table-responsive">
                <table class="table borderless" id="procedure_table" align=center>
                  <tr id="row1">
                    <td><input type="text" name="members[0][name_of_surgery]" placeholder="Procedure Name" class="form-control"></td>
                    <td><input type="text" name="members[0][status]" placeholder="Procedure Description" class="form-control"></td>
                    <td><input type="hidden" name="members[0][afya_user_id]" value="{{$patient->id}}"></td>
