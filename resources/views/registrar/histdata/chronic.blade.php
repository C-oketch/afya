    ...
    <div class="tabs-container">
      ...
      <div class="tabs-left">
        <ul class="nav nav-tabs">
          ...
          <li class="active"><a href="{{ url('registrar.chronichistdata',$patient->app_id) }}" >Chronic Disease</a></li>
        ...
        <div class="tab-content ">
          <div id="tab-6" class="tab-pane active">
            <div class="panel-body">
              ...
              {!! Form::open(array('url' => 'registrar.chronic','method'=>'POST' ,'id'=>'add_proc')) !!}
                ...
                <table class="table borderless" id="procedure_table" align=center>
                  <tr id="row1">
                    ...
                    <td><input type="hidden" name="members[0][afya_user_id]" value="{{$patient->id}}">
                      <input type='hidden' name='members[0][appointment_id]' value='{{$app_id}}'>
                    </td>
                  </tr>
                </table>
