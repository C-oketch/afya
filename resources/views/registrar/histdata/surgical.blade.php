    ...
    <div class="tabs-container">
      ...
      <div class="tabs-left">
        <ul class="nav nav-tabs">
          ...
          <li class="active"><a href="{{ url('registrar.surghistdata',$patient->app_id) }}" >Surgical Procedures</a></li>
        ...
        <div class="tab-content ">
          <div id="tab-6" class="tab-pane active">
            <div class="panel-body">
              ...
              {!! Form::open(array('url' => 'registrar.surgical','method'=>'POST' ,'id'=>'add_proc')) !!}
