...
$insurance = DB::table('insurance_companies')
          ...
          ->get();
$ptids = DB::table('patient_test_details_n')
        ->select('patient_test_id','id','appointment_id')
        ->where('id',$ptdidn)->first();
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                ...
                                <div class="col-sm-6"><h4>Payment</h4>
                                  ...
                                  {!! Form::open(array('url' => 'regpayneurology','method'=>'POST')) !!}
