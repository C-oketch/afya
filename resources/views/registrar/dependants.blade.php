...
<div class="row">
    ...
    <div class="ibox-title">
        <h5>Dependant Details</h5>
         ...
         <div class="ibox-tools">
             <a href="{{URL('registrar.addDependents',$id)}}" class="btn btn-primary btn-primary">Add Dependant</a>
         </div>
  ...
  <thead>
        ...
        <tr>
          ...
          <td><a href="{{ url('new-parent?id='.$id.'&dep_id='.$dependant->id)}}" class="btn btn-primary btn-primary">Add Parent/Guardian </a></td>
