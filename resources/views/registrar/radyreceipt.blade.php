...
<div class="row wrapper border-bottom white-bg page-heading">
  ...
  <div class="col-lg-4">
    <div class="title-action">
      ...
      <a href="{{ URL('registrar.shows_pay', $receipt->appid) }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back </a>
          ...
          <div class="row">
            <div class="col-sm-4">
              <address>
                ...
                <strong>Patient:</strong><br> {{$receipt->firstname}} {{$receipt->secondName}}<br>
                @else
                <strong>Patient:</strong><br> {{$receipt->dep_fname}} {{$receipt->dep_lname}}<br>
                @endif
