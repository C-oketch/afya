...
<div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-6">
                    <div class="title-action">
                      <a href="{{ url('registrar.shows',$patient->id) }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back </a>
<br><br><br>
                    </div>
                </div>
            </div>
...
{!! Form::open(array('url' => 'Reg_store','method'=>'POST','class'=>'form-horizontal')) !!}
