          ...
          <label for="exampleInputPassword1">Do you have a written prescription?</label>
           ...
           <div class="ibox float-e-margins" id="two" style="display:none">
               ...
               <div class="ibox-content">
                       ...
                       <form class="form-horizontal" role="form" method="POST" action="/dependant_prescription_details" >
                      <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <input type="hidden" class="form-control"  value="{{$dep_id}}" name="dependant_id" >
                      <input type="hidden" class="form-control"  value="{{$parent_id}}" name="afya_user_id" >
