                                    ...
                                    <?php  $i =1;?>
                                      ...
                                      else
                                      {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{route('private.show_receiptc',$apatient->app_id)}}">View Receipt</a></td>
                                            @elseif($apatient->paycatid == 3)
                                            <td><a href="{{url('private.radyreceipt2',$apatient->app_id)}}">View Receipt</a></td>
                                            @elseif($apatient->paycatid == 2)
                                            <td><a href="{{url('private.labreceipt2',$apatient->app_id)}}">View Receipt</a></td>
                                           @endif                                       </tr>
                                      <?php $i++ ?>
                                        @endforeach
                                         </tbody>
