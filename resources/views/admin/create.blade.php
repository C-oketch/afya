  ...
  <div class="ibox-title">
      <h5>Add Facility Admin</h5>
         ...
         <div class="ibox-content">
               <form class="form-horizontal" role="form" method="POST" action="{{url('adminstore')}}" novalidate>
             ...
             <div class="form-group"><label class="control-label">Facilty Type</label>
             ...
             <div class="form-group">
                     ...
                     <select  id="facility" name="facility" class="form-control facility"></select>
                 </div>
