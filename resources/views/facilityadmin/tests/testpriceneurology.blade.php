@extends('layouts.facilityadmin2')
                       ...
                       ?>
                                ...
                                <tr class="item{{$i}}">
                                  ...
                                  <td>
                                    ...
                                    <a class ="btn btn-danger" href="{{route('deleteneurology',$item->tpoid)}}">REMOVE</a>
                                ...
                                <tr class="item{{$i}}">
                                  ...
                                  <td>
                                     <button class="add-modal btn btn-primary" data-id="{{$tsts->testId}}"
                                      ...
                                      <?php   $added =DB::table('testprice_neurology')
                                         ->where('tests_id',$tsts->testId)
                                         ->first();
                                        ?>
                                        @if($added)
      ...
      <!-- Modal ADD-->
          <div id="myModal" class="modal fade" role="dialog">
            ...
            {!! Form::open(array('url' => 'addneurology','method'=>'POST', 'class'=>'form-horizontal')) !!}
            ...
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    {!! Form::open(array('url' => 'editneurology','method'=>'POST', 'class'=>'form-horizontal')) !!}
                    <div class="form-group">
