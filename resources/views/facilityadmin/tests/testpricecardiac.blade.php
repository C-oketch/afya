  @extends('layouts.facilityadmin2')
                         ...
                         ?>
                                  ...
                                  <tr class="item{{$i}}">
                                    ...
                                    <td>
                                      ...
                                      <a class ="btn btn-danger" href="{{route('deletecardiac',$item->tpoid)}}">REMOVE</a>
                                 ...
                                 <thead>
                                   ...
                                   <?php   $i =1; ?>
                                       ...
                                       <button class="add-modal btn btn-primary" data-id="{{$tsts->testId}}"
                                        ...
                                        <?php   $added =DB::table('testprice_cardiac')
        ...
        <!-- Modal ADD-->
              ...
              {!! Form::open(array('url' => 'addcardiac','method'=>'POST', 'class'=>'form-horizontal')) !!}
        ...
        <br>
            ...
            <div id="myModal2" class="modal fade" role="dialog">
          		<div class="modal-dialog">
                      ...
                      {!! Form::open(array('url' => 'editcardiac','method'=>'POST', 'class'=>'form-horizontal')) !!}
          						<div class="form-group">
