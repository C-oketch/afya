  @extends('layouts.facilityadmin2')
                         ...
                         ?>
                                  ...
                                  <tr class="item{{$i}}">
                                    ...
                                    <td>
                                      ...
                                      <a class ="btn btn-danger" href="{{route('deleteItem',$item->tpoid)}}">REMOVE</a>
        ...
        <!-- Modal ADD-->
              ...
              {!! Form::open(array('url' => 'addItem','method'=>'POST', 'class'=>'form-horizontal')) !!}
        ...
        <br>
            ...
            <div id="myModal2" class="modal fade" role="dialog">
          		<div class="modal-dialog">
                      ...
                      {!! Form::open(array('url' => 'editItem','method'=>'POST', 'class'=>'form-horizontal')) !!}
          						<div class="form-group">
