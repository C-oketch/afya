               ...
               ?>
                        ...
                        <tr class="item{{$i}}">
                          ...
                          <td>
                            ...
                            <a class ="btn btn-danger" href="{{route('deletemri',$item->tpoid)}}">REMOVE</a>
                        ...
                        <tr class="item{{$i}}">
                          ...
                          <td>
                             <button class="add-modal btn btn-primary" data-id="{{$tsts->testId}}"
                              ...
                              <?php   $added =DB::table('test_prices_mri')
                                 ->where('mri_id',$tsts->testId)
                                 ->first();
                                ?>
                                @if($added)
...
<!-- Modal ADD-->
  <div id="myModal" class="modal fade" role="dialog">
    ...
    {!! Form::open(array('url' => 'addmri','method'=>'POST', 'class'=>'form-horizontal')) !!}
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <!-- <form class="form-horizontal" role="form">
            ...
            {!! Form::open(array('url' => 'editmri','method'=>'POST', 'class'=>'form-horizontal')) !!}
            <div class="form-group">
