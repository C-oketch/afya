...
@section('content')
<?php
$afya_user_id=$ctscan->afya_user_id;
  $dependant_id=$ctscan->dependant_id;
  $ptid=$ctscan->ptid;


if ($ctscan->dependant_id =='Self') {
  $name= $ctscan->firstname.''.$ctscan->secondName;
  $gender=$ctscan->gender;
  $dob=$ctscan->dob;

}else{
  $name= $ctscan->depname1.''.$ctscan->depname2;
  $gender=$ctscan->depgender;
  $dob=$ctscan->depdob;
...
<?php
$i=1;?>
<?php  $cttests = DB::table('ct_scan')->get();  ?>
