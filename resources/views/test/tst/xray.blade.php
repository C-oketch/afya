...
@section('content')
<?php
  $afya_user_id=$xray->afya_user_id;
  $dependant_id=$xray->dependant_id;
  $ptid=$xray->ptid;


if ($xray->dependant_id =='Self') {
  $name= $xray->firstname.''.$xray->secondName;
  $gender=$xray->gender;
  $dob=$xray->dob;

}else{
  $name= $xray->depname1.''.$xray->depname2;
  $gender=$xray->depgender;
  $dob=$xray->depdob;
