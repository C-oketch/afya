...
<?php
	...
	$findings = DB::table('ultrasound_findings')
->whereNotExists(function($query)use($rtdid)
		{
				$query->select(DB::raw(1))
							->from('radiology_test_result')
							->where('radiology_td_id', '=',$rtdid)
							->whereRaw('ultrasound_findings.id = radiology_test_result.findings_id');
					 })
->where('ultrasound_findings.ultrasound_id', '=',$ultraid)
->select('ultrasound_findings.id','ultrasound_findings.findings',
 'ultrasound_findings.results')
->get();
	?>
<div class="row">
	<div class="col-md-11">
		...
		<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
								...
								{{ Form::open(array('route' => array('ultrafindings'),'method'=>'POST')) }}
...
<div class="col-md-6">
		<div class="ibox float-e-margins">
			...
			->leftJoin('radiology_test_result', 'ultrasound_findings.id', '=', 'radiology_test_result.findings_id')
				...
				->where([ ['ultrasound_findings.ultrasound_id', '=',$ultraid],['radiology_test_result.radiology_td_id', '=',$rtdid] ])
		...
		<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
										...
										<!-- <p>Sign in today for more expirience.</p> -->
											...
											<input type="hidden" name="radiology_td_id" value="{{$rtdid}}" >
                        <input type="hidden" name="patient_test_id" value="{{$ptId}}"  >
