						...
						->get();
						 ?>
							<div class="row">
						                              ...
						                              <h5>ALL RADIOLOGY TESTS DONE</h5>
																				...
																				<thead>
																														...
																														<tbody>
																															...
																															?>
																															<tr>
																															<td><a href="{{route('radTestd',$tst->tid)}}">{{$i}}</a></td>
																															<td><a href="{{route('radTestd',$tst->tid)}}">{{$pname}}</a></td>
																															<td>
																																@if($tst->persontreated=='Self')
																																Primary @else
																																<a href="{{route('radTestd',$tst->tid)}}">{{$pnamed}}</a>
																																 @endif
																															</td>
																															<td>{{$gender}}</td>
																															<td>{{$age}}</td>
