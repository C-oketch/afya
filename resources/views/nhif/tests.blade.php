...
<div>
    ...
    <div class="modal inmodal" id="addtest" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div id="1" class="group">
          ...
          <select class="test-multiple form-control" name="test_cat"  style="width: 100%" onChange="test_subcat(this.value)">
        ...
        <div class="form-group">
        <label for="tag_list" class="">Test Sub-Category2:</label>
