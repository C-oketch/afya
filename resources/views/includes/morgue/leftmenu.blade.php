...
<li><a href="{{ url('#') }}">Available Stock</a></li>
<li><a href="{{ url('#') }}">Admission</a></li>
<li><a href="{{ url('#') }}">Fridge Tracking</a></li>
<li><a href="{{ url('#') }}">Costing</a></li>
<li><a href="{{ url('#') }}">Post Mortem</a></li>
<li><a href="{{ url('#') }}">Released stock</a></li>
<li><a href="{{ url('#') }}">Management Reports</a></li>
<li><a href="{{ url('/logout') }}">Logout</a></li>
