...
<li class="active">
<a href="{{url('finance')}}"><i class="fa fa-th-large"></i> <span class="nav-label">Dashboards</span> <span class="fa arrow"></span></a>
...
<li>
<a href="{{ URL::to('payments') }}"><i class="fa fa-money"></i> <span>Fee Payments</span>
<a href="{{ URL::to('pending') }}"><i class="fa fa-money"></i> <span>Pending Payments</span>
