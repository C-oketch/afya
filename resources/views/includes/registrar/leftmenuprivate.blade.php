  ...
  <div class="sidebar-collapse">
    <ul class="nav metismenu" id="side-menu">
      <li class="nav-header">
        ...
        ->select('facility_registrar.facilitycode','facilities.set_up','facilities.payment')
        ...
        ->where([['facility_id',$facilitycode],['status',0]])
        ...
        ->count();
        ?>
        <li class=""><a href="{{ URL::to('registrar') }}"><i class="fa fa-users"></i> <span class="nav-label">Waiting List</span> <span class="badge"><?php echo $patients; ?></span></a></li>
        @if($path =='A')
        <!-- <li><a href="{{ URL::to('onboarding') }}"><i class="fa fa-user-o"></i>Onboarding</a><li> -->
        <li><a href="{{ URL::to('fees') }}"><i class="fa fa-money"></i><span class="nav-label">Collect Fees</span>  <span class="badge"></span></a></li>
        @endif
        <li><a href="{{ URL::to('allpatients') }}"><i class="fa fa-database"></i><span class="nav-label">All Patients</span> <span class="badge">{{$allpatients}}</span></a><li>
          <li><a href="{{ URL::to('register_new_patient') }}"><i class="fa fa-user-o"></i>New Patients</a><li>
        <li class="{{ isActiveRoute('reg.app1') }}"><a href="{{ URL::to('appointmentsmade') }}"><i class="fa fa-address-book"></i>Appointments</a><li>
