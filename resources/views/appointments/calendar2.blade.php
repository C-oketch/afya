...
{!! Form::model($user,array('route' => 'calendardoc.store','method'=>'POST')) !!}
<div class="row">
  ...
  <div class="col-xs-12 col-sm-12 col-md-12">
    ...
    {!! Form::hidden('afya_user_id',$user->id, array()) !!}
    {!! Form::hidden('appointment_id',$app_id, array()) !!}
  ...
  <div class="col-xs-12 col-sm-12 col-md-12">
    ...
    {!! Form::text('filenumber',$user->filenumber, array('placeholder' => 'filenumber','class' => 'form-control')) !!}
    </div>
  </div>
 ...
 <div class="col-xs-12 col-sm-12 col-md-12">
  ...
  <div class="form-group col-xs-12 col-sm-12 col-md-12">
   <label for="role" class="control-label">Doctor note</label>
    {{ Form::textarea('app_note', null, array('placeholder' => 'note..','class' => 'form-control col-lg-8')) }}
  </div>
...
?>
  ...
  <button type="button" data-toggle="modal" data-target="#{{$appointment->id}}m" id="{{$appointment->id}}" class="hidden-btn"></button>
                            ...
                            <div class="modal inmodal" id="{{$appointment->id}}m" tabindex="-1" role="dialog" aria-hidden="true">
                                ...
                                <div class="modal-content animated bounceInRight">
                                      ...
                                      <p><strong>Created ON:</strong> {{$appointment->created_at}}</p>
                                       ...
                                       <div class="col-md-6">
                                       <p><strong>Doctor's Note:</strong><br>
                                         <textarea  rows="10" cols="10" class="form-control" readonly>{{ $appointment->notes }}</textarea>
                                          </p>
                                        </div>
                  ...
                  {!! Form::open(['method' => 'DELETE','route' => ['calendardoc.destroy', $appointment->id],'style'=>'display:inline', 'onsubmit' => 'return ConfirmDelete()']) !!}
  ...
  {!! Form::model($appointment, ['method' => 'PATCH','route' => ['calendardoc.update', $appointment->id]]) !!}
<div class="row">
  <input type="hidden" name="id" value="{{$appointment->id}}" >

  {!! Form::hidden('afya_user_id',$user->id, array()) !!}
  {!! Form::hidden('appointment_note_id',$appointment->note_id, array()) !!}
...
<strong>Appointment Time:</strong>
 ...
 <div class="col-xs-12 col-sm-12 col-md-12">
  ...
  <div class="col-xs-12 col-sm-12 col-md-12">
     ...
     <textarea  rows="10" cols="10" class="form-control" name="doc_notes">{{ $appointment->notes }}</textarea>
