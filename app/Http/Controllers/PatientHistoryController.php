...
return view('doctor.histdata.histdata',$data)->with('patient',$patient);
        }
  ...
  return view('doctor.histdata.medicalh',$data)->with('patient',$patient);
  ...
  return view('doctor.histdata.surgical')->with('patient',$patient);
        }
...
return view('doctor.histdata.chronic')->with('patient',$patient);
}
...
return view('doctor.histdata.mediccine')->with('patient',$patient);
}
...
return view('doctor.histdata.allergy')->with('patient',$patient);
}
...
return view('doctor.histdata.functions')->with('patient',$patient);
}
...
return view('doctor.histdata.vaccine')->with('patient',$patient);
}
...
return redirect()->action('PatientHistoryController@surghistdata',[$appid]);
...
return redirect()->action('PatientHistoryController@vacchistdata',[$appid]);
}
...
return redirect()->action('PatientHistoryController@medhistdata',[$appid]);
}
...
return redirect()->action('PatientHistoryController@allergyhistdata',[$appid]);
}
...
DB::table('patient_abnormalities')->insert($input);
  return redirect()->action('PatientHistoryController@abnorhistdata',[$appid]);
