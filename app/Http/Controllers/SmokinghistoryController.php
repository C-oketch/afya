...
class SmokinghistoryController extends Controller
{
    ...
    {
        Smokinghistory::create($request->all());
    ...
    public function update(Request $request, $id)
    {
        ...
        $smokinghistory=Smokinghistory::find($id);
     ...
     * @return \Illuminate\Http\Response
     */
    public function updatesmoking(Request $request)
    {
       $id=$request->smoking_id;
        $smokinghistory=Smokinghistory::find($id);
        $smokinghistory->update($request->all());
