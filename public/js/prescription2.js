$(document).ready(function() {
    ...
    //ADD FUNCTION
        ...
        //             $('.item' + data.id).replaceWith("<tr class='item" + data.id + "'><td>" + data.drugname + "</td><td>" + data.Ingridients + "</td><td><button class='btn btn-info'>ADDED</button></td></tr>");
        //            }
        //         },
        //     });
        // });
