$(document).ready(function() {
  ...
  $(document).on('click', '.edit-modal', function() {
        ...
        $('#n2').val($(this).data('name'));
        $('#av2').val($(this).data('avala'));
        $('#tpoid2').val($(this).data('tpoid'));
        $('#amnt2').val($(this).data('amount'));
        $('#optionp2').val($(this).data('optionp'));
        $('#myModal2').modal('show');
    });
    //ADD MODAL
...
//             $('.item' + data.nomb).replaceWith("<tr class='item" + data.nomb + "'><td>" + data.nomb + "</td><td>" + data.name + "</td><td>" + data.availability + "</td><td>" + data.amount + "</td><td>" + data.tponame + "</td><td><button class='edit-modal btn btn-info' data-nomb='" + data.nomb + "' data-id='" + data.id + "' data-name='" + data.name + "' data-aval='" + data.availability + "' data-amount='" + data.amount + "'><span class='glyphicon glyphicon-edit'></span> Edit</button></td></tr>");
//         }
//     });
// });
